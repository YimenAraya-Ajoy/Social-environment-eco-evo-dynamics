...
s1c.x <- create.x(scenID="1c",  n.years=n.years, r=0.3, Bnr=-0.35, Bzr= 0.17, Bzr2=   -0.01)
s1d.x <- create.x(scenID="1d",  n.years=n.years, r=0.3, Bnr=-0.35, Bzr= 0.23, Bzr2= -0.01)
...
save.image("Results/Selection.RData")


est_all_res_s1b$est_m_res
est_all_res_s1c$est_m_res
est_all_res_s1d$est_m_res
